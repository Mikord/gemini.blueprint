...
//                      DependencyAwareBeanFactoryPostProcessor.class, null);
  ...
  protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
    PostProcessorRegistrationDelegate.invokeBeanFactoryPostProcessors(beanFactory, getBeanFactoryPostProcessors(), DependencyAwareBeanFactoryPostProcessor.class);
  }
...
//                                               Class<?> exclude) {
//    PostProcessorRegistrationDelegate.invokeBeanFactoryPostProcessors(beanFactory, getBeanFactoryPostProcessors(), exclude);
...
//  }
  ...
  protected void registerBeanPostProcessors(ConfigurableListableBeanFactory beanFactory) {
    PostProcessorRegistrationDelegate.registerBeanPostProcessors(beanFactory, this, DependencyInitializationAwareBeanPostProcessor.class, true);
  }
...
//    PostProcessorRegistrationDelegate.registerBeanPostProcessors(beanFactory, this, exclude, check);
//    String[] postProcessorNames = beanFactory.getBeanNamesForType(type, true, false);
//
//    if (check) {
